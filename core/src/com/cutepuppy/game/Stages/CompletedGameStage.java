...
public class CompletedGameStage extends Stage {
    public CompletedGameStage(Viewport viewport) {
        ...
        buttonMenu.setSize(buttonMenu.getWidth()/4, buttonNextLevel.getHeight()/4);
        ...
        buttonNextLevel.setPosition(getWidth()/2, getHeight()-buttonNextLevel.getHeight());
        buttonMenu.setPosition(getWidth()/2, getHeight()-buttonNextLevel.getHeight()-10-(buttonMenu.getHeight()));
